					...
					<form action="#">
						<div class="panel-body">
							<div class="form-group">
								<input type="text" class="form-control" placeholder="일기 제목">
							</div><!-- .form-group -->
								...
								<div class="row">
									...
									<div class="col-sm-6">
											...
											<label class="radio-inline">
												<input type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1"> 맑음
											</label>
											<label class="radio-inline">
												<input type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2"> 비
											</label>
											<label class="radio-inline">
												<input type="radio" name="inlineRadioOptions" id="inlineRadio3" value="option3"> 눈
											</label>
											<label class="radio-inline">
												<input type="radio" name="inlineRadioOptions" id="inlineRadio4" value="option3"> 바람
											</label>
									</div>
								</div>
							</div><!-- .form-group -->
							...
							<textarea name="new_message_body" class="form-control full-wysiwyg"  rows="10" placeholder="오늘의 일기"></textarea>
						</div><!-- .panel-body -->
