			...
			<div class="col-md-10">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title">캘린더</h4>
					</header>
					<!-- .widget-header -->
					<hr class="widget-separator">
					<div class="widget-body">
						<div class="m-b-lg">
							<small> 날짜를 누르면 해당 일기가 조회됩니다. </small>
						</div>
											...
											success : function(res) {
												...
												for (let i = 0; i < res.length; i++) {
													...
													html += '<strong>'
															...
															+ '</strong>';
													html += '</h4>';
													html += '<small class="media-meta">'
															+ data.journal_regdate
															+ '</small>';
													html += '<br>';
													html += '<small class="media-meta">'
															+ data.journal_weather
															+ '</small>';
													html += '<textarea readonly="readonly" class="form-control">'
