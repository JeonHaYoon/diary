		...
		<div class="row">
			<div class="col-md-3">
				<div class="app-action-panel" id="calendar-action-panel">
					...
					<div class="m-b-lg">
						<a href="selectWrite"  class="btn btn-lg btn-primary btn-block">A or B 등록</a>
					</div>
						...
						<div class="col-md-9">
							...
							<table class="table">
								...
								<tr>
									...
									<td><a href="selectRead?select_pk=<c:out value="${select.select_pk}"/>"><c:out value="${select.select_title}"/></a></td>
									<td><c:out value="${select.select_writer}"/></td>
									<td><c:out value="${select.select_category}"/></td>
									<td><fmt:formatDate value="${select.select_regdate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
