  ...
  <div class="profile-header">
	<div class="profile-cover">
		...
		<div class="text-center">
			...
			<p>닉네임 : <sec:authentication property="principal.member.nickname"/></p>
			</h4>
			<div>
				<h5><p>생년월일 : <sec:authentication property="principal.member.birth"/></p></h5>
				<h5><p>지역 : <sec:authentication property="principal.member.region"/></p></h5>
	 ...
	 <script type="text/javascript">
      $(document).ready(function () {
        $('#btn_save').click(function () {
          ...
          var radioVal = $('input[name="weatherRadio"]:checked').val();
